...
public class InicioSesionAdmin extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        TxtAdministrador.setBackground(new java.awt.Color(204, 204, 204));
    ...
    private void botonConfirmarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonConfirmarActionPerformed
        if(!TxtAdministrador.getText().isEmpty()&&!txtClave.getText().isEmpty()) {
            if(AdministradorLogic.autentificar(TxtAdministrador.getText(),txtClave.getText())){
